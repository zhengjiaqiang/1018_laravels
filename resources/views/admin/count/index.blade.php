                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">最后充值时间</span></th>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('admin/show')}}?user_id=<?php echo $v['user_id'];?>">查看</td>
                        </tr>
                   <?php } ?>
                        </tbody>
                    </table>
