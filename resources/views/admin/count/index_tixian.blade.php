                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th><span class="glyphicon glyphicon-list"></span> <span class="visible-lg">提现总金额</span></th>
                            <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">最后提现时间</span></th>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('admin/tixian_list')}}?user_id=<?php echo $v['user_id'];?>">查看</td>
                        </tr>
                        <?php } ?>
                        </tbody>
                    </table>
