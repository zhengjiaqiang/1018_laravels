...
//			});
    ...
    <div class="rightFix" style="position:fixed;width:127px;height:165px;top:240px;left:50%;margin-left:510px;z-index:50;">
        <a href="/Activity-getnewers" style="display:block;width:100%;height:100%;">
            <img style="display:block;width:100%;height:100%;" src="statics/home2/images/december-expermoney/right_fix1.png" alt="">
        </a>
    </div>
    <!-- 右侧悬浮窗end -->
    <head>
        ...
        <title>新手体验项目详情</title>
        <link rel="stylesheet" href="statics/home2/css/tiyanjin.css?20160520">
        <link rel="stylesheet" href="statics/home2/css/m2-loginModify.css?20160520">
        <link rel="stylesheet" href="statics/home2/css/actPrize.css?20160520">
    ...
    <div class="nolog" style="display:none;">
        ...
        <div class="nologbox z101">
            <div class="nologbox_b">
                <p></p>
                <div>
                    <img src="statics/home2/images/december-expermoney/yellow_q.png">
                    您还没有登录，请立即去登录。
                </div>
                <a href="/login">去登录</a>
                <div class="close"><img src="statics/home2/images/december-expermoney/close.png"></div>
            </div>
        </div>
    </div>
    <!--未登录-->
    ...
    <div class="m2-detialsItem">
        <div class="m2-detItemlef">
            <div class="m2-detItemlef-img">
                <img src="statics/home2/images/december-expermoney/exclusive.png" alt="">
...
<script type="text/javascript">
    ...
    var GV = {
        ...
        TOKEN: "3af9ff064ad069a3760fe2210531911d_ca2141695f744c2230547d4575d3a724",
        THIS_URL: "Tiyanjin-",
