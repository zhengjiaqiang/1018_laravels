...
<head>
    ...
    <link rel="stylesheet" href="statics/home2/css/m2-main.css?20160520">
    <script type="text/javascript" src="statics/home2/js/jquery.knob.js"></script>
    <script type="text/javascript" src="statics/home2/js/jquery.SuperSlide.js"></script>
    <!--公共提示框start-->
...
<div class="m2-tranHide">
    ...
    <div class="m2-tranHide-box">
        ...
        <div class="m2-tranHiderem">
            <span>账户余额：</span>
            <a href="{{asset('home/login')}}" target="_blank">登录</a>后可看                <b class="invest_all">全用</b>
        </div>
        ...
        <div class="m2-commonTop-right">
            <div class="m2-commonTop-link">
                <ul>
                    ...
                    <li class="m2-commonTop-btn"><a href="{{asset('home/register')}}" target="_blank">注册</a></li>
                    <li class="m2-commonTop-btn"><a href="{{asset('home/login')}}" target="_blank" style="border-right:none;">登录</a></li>
    ...
    <div class="m2-commonNav-box">
        ...
        <div class="m2-commonNav">
            <ul class="m2-commonNavul-fir" data_page='onepage'>
                ...
                <li class="m2-commonNav-fir"><a href="" id="fivepage">关于我们</a></li>
        ...
        <div class="mo2-indexLoginbox">
            ...
            <div class="mo2-indLoged" style="display: none">				<div class="mo2-indLoged-tit"><span>你好！<span style="color:#f34940;"></span>，欢迎来到爱钱帮</span></div>
                <div class="mo2-indLog-userHead">
                    <a href="usercenter.html"><img src="statics/home2/images/user-head.png" title="欢迎来到爱钱帮投资理财平台" alt=""></a>
                </div>
...
<div class="comregist" id="newregister" style="display:none;">
    ...
    <div class="comregistbox z101">
        <div class="comregistbox_b">
            <p></p>
            <div>
                <img src="statics/home2/images/december-expermoney/regist.png" alt="恭喜您注册爱钱帮，20000元体验金已经发送您的账户">
                <span class="incentivebox_bp1">恭喜您注册爱钱帮，<span class="red">20000元</span>体验金已经发送您的账户</span>
                <p class="comregistbox_bp2">您可以去体验金项目进行投资</p>
            </div>
            <a href="{{url('tiyan/now_invest')}}">去投资</a>
            <div class="close" id="newregister-close"><img src="statics/home2/images/december-expermoney/close.png" alt="点击取消"></div>
        </div>
    </div>
</div>
<!--新用户完成注册-->
        ...
        <ul>
            <li class="mo2-indSteite  mo2-indSteite1">
                <a href="anquanlicai_baozhang.html" target="_blank">
                    ...
                    <div class="mo-indSterig">
                        <p class="mo2-indSte-big"><a href="{{url('home/index/kekao')}}">安全可靠</a></p>
            ...
            <li class="mo2-indSteite  mo2-indSteite2">
                <a href="touzi_licai_chanpin.html" target="_blank">
                    ...
                    <div class="mo-indSterig">
                        <p class="mo2-indSte-big"><a href="{{url('home/index/shouyi')}}">安全收益</a></p>
            ...
            <li class="mo2-indSteite  mo2-indSteite3">
                <a href="touzi_licai_chanpin.html" target="_blank">
                    ...
                    <div class="mo-indSterig">
                        <p class="mo2-indSte-big"><a href="{{url('home/index/fangbian')}}">灵活方便</a></p>
            ...
            <li class="mo2-indSteite  mo2-indSteite4" style="width:174px;">
                <a href="guanyu_aiqianbang.html" target="_blank">
                    ...
                    <div class="mo-indSterig">
                        <p class="mo2-indSte-big"><a href="{{url('home/index/xionghou')}}">实力雄厚</a></p>
        ...
        <div class="mo2-indWbq">
            ...
            <div class="mo2-indWbqmain">
                ...
                <div class="mo2-indWbqmain-rig">
                    <h4><a href="{{url('home/tiyan')}}" target="_blank" title="爱钱帮理财新手体验金项目">爱钱帮理财新手体验金项目</a></h4>
                    ...
                    <div class="mo2-indWbqrig-main">
                        ...
                        <div class="mo2-wbqBtn">
                            {{--立即投资--}}
                            <a href="{{url('home/tiyan/now_invest')}}" target="_blank">即将开始</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <ul class="mo2-indCar">
                <li class="mo2-indCarlist mo2-indCarlist-ing">                <div class="mo2-indCartop">
                        <div class="mo2-indCartop-img">
                            <i class="mo2-listNewicon"></i>                        <img src={{asset('uploadData/UserBorrowData/182015-20160902132425642.jpg')}} alt="爱车贷-雪佛兰迈锐宝-XAA067" title="爱车贷-雪佛兰迈锐宝-XAA067" onclick="window.open('duanqi_licai_chanpin-moxOeTwTZaOw8TY79g.html')"/>
                        </div>
